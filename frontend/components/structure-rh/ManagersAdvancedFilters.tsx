...
export interface ManagersFilters {
  search?: string;
  siteId?: string;
  departmentId?: string;
}
...
interface ManagersAdvancedFiltersProps {
  ...
  onFiltersChange: (filters: ManagersFilters) => void;
  onReset: () => void;
  sites: any[];
  departments: any[];
  isOpen: boolean;
...
export function ManagersAdvancedFilters({
  filters,
  onFiltersChange,
  onReset,
  sites,
  ...
  isOpen,
  onToggle,
}: ManagersAdvancedFiltersProps) {
  const hasActiveFilters = 
    !!filters.search ||
    !!filters.siteId ||
    !!filters.departmentId;

  const handleFilterChange = (key: keyof ManagersFilters, value: string) => {
    onFiltersChange({
      ...filters,
      [key]: value || undefined,
    });
          ...
          <CardContent className="p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Input
                  type="text"
                  placeholder="Site, département, manager..."
