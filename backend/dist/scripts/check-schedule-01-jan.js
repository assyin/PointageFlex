...
async function checkSchedule() {
    try {
        ...
        const startOfDay = new Date(Date.UTC(2025, 11, 31, 0, 0, 0, 0));
        const endOfDay = new Date(Date.UTC(2026, 0, 2, 23, 59, 59, 999));
...
checkSchedule();
//# sourceMappingURL=check-schedule-01-jan.js.map